   ...
   <!-- Footer -->
   <footer class="bg-coffee-800 text-coffee-200 py-8 px-4 mt-8">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
     <div class="flex items-center gap-2">
      <i data-lucide="clapperboard" class="w-5 h-5"></i> <span class="font-display font-semibold">Ethiopian Cinema</span>
     </div>
     <p class="text-sm text-coffee-300">© 2024 Cinema Management. All rights reserved.</p>
    </div>
   </footer>
  </div>
  <script>
    ...
    document.querySelectorAll('.movie-overlay button, .movie-overlay a').forEach(btn => {
        btn.addEventListener('click', (e) => {
            e.stopPropagation();
            // If the button is a link we navigate, otherwise show quick feedback
